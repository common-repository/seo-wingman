<div class="container">
	<h2>Hello {{ $root.subscriber.metadata.name }}, welcome back</h2>
	<div id="tabs">
		<div class="tabs-buttons">
			<ul>
				<li><a href="#tab-1" class="wingman-btn wingman-btn-act wingman-btn-small">Dashboard</a></li>
				<li><a href="#tab-2" class="wingman-btn wingman-btn-act wingman-btn-small">Keywords and Competitors</a></li>
				<li><a href="#tab-3" class="wingman-btn wingman-btn-act wingman-btn-small">My Account</a></li>
			...
			<div id="tab-1" ng-controller="S3Controller" ng-init="load()">
				<div class="row">
						...
						<div class="pg-border">
							...
							<div class="pg-text pg-mt-20">
								...
								<div class="pg-border pg-pad-20 messages">
									...
									<div ng-repeat="msg in messages | orderBy:'-msg.timestamp'" ng-class="{'me': msg.name == $root.subscriber.metadata.name}">
								...
								<form ng-submit="send()" novalidate class="pg-mt-20 wingman-message-form" style="margin: 0;">
									<div class="row">
										<div class="col-sm-9">
											<div class="pg-text">
												<div>
					...
					<div class="pg-pad-20 pg-pad-20 pg-border">
						<div class="row">
							<div class="col-sm-6 pg-totals-averages">
						...
						<div class="pg-text">
							<div class="pg-border pg-pad-20 pg-mb-20 files pg-white-bckg">
								...
								<div ng-repeat="file in files">
									<a ng-href="{{ file.url }}" download target="_blank">{{ file.name }} <sup ng-show="$index == 0">NEW</sup></a>
									<a ng-href="{{ file.url }}" download target="_blank" class="wingman-btn wingman-btn-small-x wingman-btn-act">Download</a>
								</div>
							</div>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<form name="keywordsForm" id="keywordsForm" novalidate>
							<formly-form model="subscription" fields="fields.keywords">
								<div class="pg-mt-20">
					...
					<div class="col-sm-6">
						<form name="competitorsForm" id="competitorsForm" novalidate>
							<formly-form model="subscription" fields="fields.competitors">
								<div class="pg-mt-20">
									<button type="button" class="wingman-btn" ng-show="!loading" ng-click="updateSubscription()">Save</button>
									<span data-ng-show="loading">Loading</span>
								</div>
